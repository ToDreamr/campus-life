...
public class SchoolLifeApplication {
    ...
    public static void main(String[] args) {
        ApplicationContext context=SpringApplication.run(SchoolLifeApplication.class, args);
        ...
        log.info("http://localhost:"+context.getEnvironment().getProperty("server.port")+"/login.html");
    }
}
